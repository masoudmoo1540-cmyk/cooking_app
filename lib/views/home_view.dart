...
class _HomeViewState extends State<HomeView> {
  ...
  bool _hasSuggested = false;
  final DatabaseService _dbService = DatabaseService();

  @override
  void initState() {
    super.initState();
    // پیشنهاد پیش‌فرض نمایش داده نمی‌شه
  }
  ...
  void _goToCookingFromSuggestion() {
    if (_suggestedMeal != null) {
      _goToDetail(_suggestedMeal!['id'] as int);
    }
  }
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              // نتیجه پیشنهاد (فقط وقتی کاربر درخواست داده)
              if (_hasSuggested && _suggestedMeal != null)
                GestureDetector(
